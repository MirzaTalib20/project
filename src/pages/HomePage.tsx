        ...
        <div className="relative z-10 container mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-24 md:py-32">
          ...
          >
            ...
            <p className="text-gray-600 text-base max-w-md mx-auto md:mx-0">
              Affordable, fast, and professional cooling equipment guaranteed
              for every occasion.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2 justify-center md:justify-start">
              ...
              <button
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-gray-400/60 
            ...
            <p className="text-gray-500 text-sm pt-4">
              Serving{" "}
              <span className="font-semibold text-gray-800">12+ Cities</span> •{" "}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-[#000000]/70 max-w-2xl mx-auto">
              We provide reliable, efficient cooling solutions with exceptional
              service quality
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Book your cooling equipment today and enjoy professional service
